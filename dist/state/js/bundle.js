...
/* harmony import */ var _lazy_VirtualElement__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lazy/VirtualElement */ "./src/lazy/VirtualElement.ts");
/* harmony import */ var _lazy_Component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lazy/Component */ "./src/lazy/Component.ts");
...
function A() {
  var d1 = (0,_lazy_VirtualElement__WEBPACK_IMPORTED_MODULE_4__.useLazyable)({
    count: 1
  });
  var d2 = (0,_lazy_VirtualElement__WEBPACK_IMPORTED_MODULE_4__.useLazyable)({
    age: 1
  });
  return _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(2, () => null, "div", [{
    "type": "normal",
    "property": "onClick",
    "value": () => () => d1.count++
  }], [() => d1.count, () => _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(1, () => null, "div", [{
    "type": "normal",
    "property": "onClick",
    "value": () => e => {
      e.stopPropagation();
...
var B = _decorate(null, function (_initialize, _Component) {
  class B extends _Component {
    constructor(...args) {
      super(...args);
  ...
  return {
    ...
    d: [{
      kind: "field",
      decorators: [(0,_lazy_Lazyable__WEBPACK_IMPORTED_MODULE_1__.State)()],
      key: "age",
      ...
      value: function render() {
        console.log(this);
        return _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(3, () => null, "div", [{
          "type": "normal",
          "property": "onClick",
          "value": () => () => this.age++
        }], [() => this.age]);
...
}, _lazy_Component__WEBPACK_IMPORTED_MODULE_5__.Component);
...
_lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.render(_lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(12, () => null, "div", [], [() => _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(4, () => null, A, [], []), () => _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(5, () => null, B, [], []), () => _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(6, () => null, B, [], []), () => _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(9, () => null, "div", [], [() => _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(7, () => null, "button", [{
  "type": "normal",
  "property": "onClick",
  "value": () => () => {
    data.arr.push(data.arr.length);
  }
}], [() => "\u589E\u52A0\u65B0\u7684\u503C"]), () => _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(8, () => null, "button", [{
  "type": "normal",
  "property": "onClick",
  "value": () => () => {
    data.arr.pop();
  }
}], [() => "\u51CF\u5C11\u65B0\u7684\u503C"])]), () => _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(11, () => null, "div", [], [() => data.arr.map((i, index) => _lazy_index__WEBPACK_IMPORTED_MODULE_0__.default.createElement(10, () => index, "div", [{
  "type": "normal",
  "property": "onClick",
  "value": () => () => {
    data.arr[index]++;
  }
}], [() => i]))]), () => data.arr]), _lazy_index__WEBPACK_IMPORTED_MODULE_0__.lazyDocument.querySelector("#root"));
...
var LazyTask = _decorate(null, function (_initialize) {
  class LazyTask {
    // 停止记录依赖
    // 可以记录以来
  ...
  return {
    ...
    d: [{
      ...
      kind: "method",
      key: "stopRecordRely",
      value: function stopRecordRely() {
        this.canRecordRely = false;
      }
    }, {
      kind: "method",
      key: "startRecordRely",
      value: function startRecordRely() {
      ...
      kind: "method",
      key: "canRecord",
      value: function canRecord(t, k, v) {
      ...
      kind: "method",
      decorators: [_utils__WEBPACK_IMPORTED_MODULE_1__.autobind],
      key: "except",
      value: function except(h) {
        this.stopRecordRely();
        var res = h();
      ...
      kind: "method",
      key: "hasStopped",
      value: function hasStopped() {
        return this.stopped;
      }
    }, {
      kind: "method",
      key: "restart",
      value: function restart(reasons, force = false) {
      ...
      decorators: [_utils__WEBPACK_IMPORTED_MODULE_1__.autobind],
      key: "removeSubTask",
      value: function removeSubTask(task, stop = true) {
        if (stop) task.stop();
...
/* harmony export */   "StateFlag": () => (/* binding */ StateFlag),
/* harmony export */   "Stateable": () => (/* binding */ Stateable),
...
var StateFlag = Symbol("state_flag");
function Stateable() {
  return target => {
    var stateProperties = target.prototype[StateFlag]; // const func = function (...args: any[]) {
    //   const temp = Lazyable({} as any);
    //   stateProperties.forEach((p) => {
    //     Object.defineProperty(this, p, {
    //       get() {
    //         return Reflect.get(temp, p);
    //       },
    //       set(v) {
    //         return Reflect.set(temp, p, v);
    //       },
    //     });
    //   });
    ...
    // target.prototype.constructor = func;
    // return func;
...
function State() {
  return function (target, property) {
    console.log(target, property, arguments); // if (!target[StateFlag]) {
    //   target[StateFlag] = [];
    // }
    // target[StateFlag].push(property);
  };
}
...
function formatResult(result) {
  ...
  return _Document__WEBPACK_IMPORTED_MODULE_1__.lazyDocument.createTextElement(typeof result === "object" ? JSON.stringify(result) : result);
}
/**
 * 对于返回的结果进行解析
 * @param result
            ...
            if (oldPosition === positionIndex) {
              while (positionIndex < oldResult.length) {
                ...
                if (positionIndex >= oldResult.length) {
                  ...
                  parent = ((_nextElement2 = nextElement) === null || _nextElement2 === void 0 ? void 0 : _nextElement2.parent) || parent;
                } else if (!usedOldIndex.has(positionIndex)) {
                  // 这个位置的元素可能已经被用过了 要忽略
                  // 如果这个位置没被用过 那就要用起来
                  elements = getElements(oldResult[positionIndex]);
                  nextElement = elements[0];
                  parent = nextElement.parent || parent; // 跳出循环
...
/* harmony export */   "StateFlag": () => (/* reexport safe */ _Lazyable__WEBPACK_IMPORTED_MODULE_6__.StateFlag),
/* harmony export */   "Stateable": () => (/* reexport safe */ _Lazyable__WEBPACK_IMPORTED_MODULE_6__.Stateable),
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("cc34b63e8f9a5c715af8")
/******/ 	})();
/******/ 	
